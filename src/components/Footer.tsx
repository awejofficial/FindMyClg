      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center justify-between space-y-6 lg:space-y-0">
          ...
          <div className="flex flex-col items-center lg:items-start space-y-3">
            ...
            <p className="text-xs text-secondary/80 max-w-md text-center lg:text-left">
              Helping diploma students find their perfect engineering college in Maharashtra
            </p>
          </div>
          
          {/* Right section - Social links */}
          <div className="flex flex-col items-center space-y-4">
            <p className="text-sm text-secondary font-medium">Connect with us</p>
